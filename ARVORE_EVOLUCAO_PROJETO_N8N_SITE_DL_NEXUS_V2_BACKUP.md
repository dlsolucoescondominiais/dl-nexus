...
- *(IDs Obsoletos: 100063696635033, 3136866194).*
...
**Campos Atuais do Formulário (#dl-contact-form):**
...
**Campos Faltantes (Para implementar na V2):**
...
- ⏸️ **140_ZELADOR_MIDIAS_GOOGLE_DRIVE:** Pausado e deve ser preservado exclusivamente como base de auditoria/descoberta/sugestão, sem nenhuma execução destrutiva.
...
- Um push limpo não substitui a necessidade de rotação de credenciais.
- Todos os tokens/chaves que foram expostos devem ser obrigatoriamente invalidados e recriados nos provedores oficiais.
- Não considerar esse problema resolvido até obter um push limpo sem GH013 E comprovar que as credenciais foram giradas nas fontes (ex: Google Cloud Console).
