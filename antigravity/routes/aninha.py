...
def triagem_lead(lead: LeadRequest, bg_tasks: BackgroundTasks):
    ...
    [Bolt Optimization]: Usando 'def' em vez de 'async def' para offload automático
    no FastAPI do I/O síncrono (aninha.fazer_triagem com client openai síncrono),
    evitando bloqueio do event loop principal.
    """
    try:
