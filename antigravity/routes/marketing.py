...
@router.post("/aprovar")
# ⚡ Bolt Optimization: Using standard 'def' instead of 'async def' because requests.post
# is a blocking, synchronous I/O call. This allows FastAPI to run the handler in a threadpool,
# preventing the main event loop from stalling during network requests.
