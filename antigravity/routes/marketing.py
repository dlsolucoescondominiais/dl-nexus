...
def aprovar_post(request: PostApprovalRequest):
    ...
    ⚡ Bolt Optimization: Removido 'async' para descarregar a requisição de rede síncrona
    (requests.post) em um pool de threads externo, impedindo o bloqueio do event loop.
    """
    try:
        headers = {
