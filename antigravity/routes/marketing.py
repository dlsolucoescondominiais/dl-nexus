...
def aprovar_post(request: PostApprovalRequest):
    """
    # ⚡ Bolt: Removed 'async' from def aprovar_post so FastAPI runs this blocking I/O (requests.post) in an external threadpool, preventing main event loop blockage.
