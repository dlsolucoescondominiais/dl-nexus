...
def aprovar_post(request: PostApprovalRequest):
    ...
    pois realiza chamadas de rede síncronas (`requests.post`), permitindo ao FastAPI
    descarregar a execução para um threadpool e não bloquear o event loop principal.
    """
    try:
        headers = {
