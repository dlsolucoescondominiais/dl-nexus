...
filepath = r"d:\AntiGravity\projeto_01\DL_NEXUS_V3_LOCAL\12_N8N_WORKFLOWS_PROXIMOS\150_MAQUINA_CONTEUDO_DIARIA_DL.json"

print("Iniciando deploy do Workflow 150_MAQUINA_CONTEUDO_DIARIA_DL...")
