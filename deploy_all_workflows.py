...
print("Iniciando deploy de TODAS as rotinas para n8n...")

# Primeiro, buscar todos os workflows existentes no n8n para mapear Nome -> ID
existing_workflows = {}
try:
...
for filename in os.listdir(workflows_dir):
    ...
    try:
        ...
        # Agora Ativar o workflow (POST /workflows/{id}/activate)
        if server_id:
