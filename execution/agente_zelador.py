...
# Cache em memoria para evitar chamadas redundantes a API do Google Drive
# Mapeia (nome_pasta, parent_id) -> folder_id
_pasta_cache = {}

def obter_ou_criar_pasta(service_drive, nome_pasta, parent_id):
    """Cria ou recupera gaveta no Drive (com cache em memoria)."""
    cache_key = (nome_pasta, parent_id)
