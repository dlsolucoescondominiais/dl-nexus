...
class SupabaseClient:
    ...
    def get_leads_summary(self) -> dict:
        ...
        # ⚡ Bolt: Loop fusion optimization. Replaced 4 O(N) iterations (2 sum generators, 2 dictionaries loops)
        # with a single O(N) pass to reduce redundant traversal over potentially large lists of leads.
        novos = 0
        triados = 0
        servicos = {}
        portes = {}
