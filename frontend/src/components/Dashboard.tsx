...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Derived state pattern
  // Calculate KPIs dynamically using useMemo dependent on 'leads' instead of manually syncing a secondary useState.
  // This reduces re-renders on realtime updates and ensures a single source of truth.
  const kpis = useMemo(() => {
    return {
