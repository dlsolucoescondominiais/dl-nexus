...
export default function Dashboard() {
  ...
  // ⚡ Bolt Optimization: Derive KPIs directly from leads state using useMemo.
  // This removes a redundant useState and prevents double re-rendering when leads update.
  const kpis = useMemo(() => {
    return {
