...
export default function Dashboard() {
  ...
  // Calculate KPIs using useMemo instead of maintaining redundant state.
  // This prevents unnecessary re-renders when updating the leads array and establishes a single source of truth.
  const kpis = useMemo(() => {
    return {
