...
export default function Dashboard() {
  ...
  const fetchDashboardData = async () => {
    ...
    // ⚡ Bolt: Optimize KPI Calculation
    // Reduces multiple O(N) array iterations to a single O(N) pass,
    // simultaneously aggregating multiple metrics.
    const { negociando, ganhos, recorrentes } = (leadsData || []).reduce(
      (acc, l) => {
