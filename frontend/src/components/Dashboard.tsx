...
export default function Dashboard() {
  ...
  // Calculates derived metrics using useMemo dependent on the primary leads dataset
  // instead of manually synchronizing a secondary useState.
  // This prevents redundant re-renders and establishes a single source of truth.
  // Expected impact: Eliminates one extra re-render cycle per real-time Supabase update.
  const kpis = useMemo(() => {
    return {
