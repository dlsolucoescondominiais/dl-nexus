...
if err: print(f"Err 070: {err}")
    ...
    res, err = n8n_request("workflows/UBH2RWc3CK2AyVR3", method="PUT", data=clean_payload(w70))
...
if err: print(f"Err 020: {err}")
    ...
    res, err = n8n_request("workflows/publicadorSocialDlNexusV320260518", method="PUT", data=clean_payload(w20))
