...
temp_workflow = {
  "name": "TEMP_EXECUTE_SQL_MIGRATION_V10",
  "nodes": [
    {
      "parameters": {
        "httpMethod": "POST",
        "path": "execute-sql-migration-v10-temp",
      ...
      "webhookId": "execute-sql-migration-v10-temp-wh-id"
    },
    {
      "parameters": {
...
try:
    ...
    webhook_url = webhook_base + "execute-sql-migration-v10-temp"
    ...
    try:
        ...
        if exec_err:
            ...
            if details_err:
                ...
                with open("scripts/migration_v10_execution_error.json", "w", encoding="utf-8") as err_f:
                    json.dump(details, err_f, indent=2, ensure_ascii=False)
                print(f"[+] Detalhes do erro salvos em scripts/migration_v10_execution_error.json")
